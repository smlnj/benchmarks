...
structure Main : BMARK =
  struct
    ...
    fun shr (n, i) =
      Word.toIntX (Word.~>> (Word.fromInt n, i))

    fun truncate (n, d) =
      if Int.abs d > 0x7FFFFFFF orelse Int.abs n > 0x7FFFFFFF then
        truncate (shr (n, 0w4), shr (d, 0w4))
      else
        (n, d)
